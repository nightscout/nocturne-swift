...
public struct UpsertHeartRateRequest: Sendable, Codable, Hashable {
    ...
    public init(timestamp: Date? = nil, utcOffset: Int? = nil, bpm: Int? = nil, accuracy: Int? = nil, device: String? = nil, app: String? = nil, dataSource: String? = nil, syncIdentifier: String? = nil) {
