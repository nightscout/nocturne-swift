# MyFitnessPalSettingsAPI

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**myFitnessPalSettingsGetSettings**](MyFitnessPalSettingsAPI.md#myfitnesspalsettingsgetsettings) | **GET** /api/v4/connectors/myfitnesspal/settings | Get global MyFitnessPal matching settings.
[**myFitnessPalSettingsSaveSettings**](MyFitnessPalSettingsAPI.md#myfitnesspalsettingssavesettings) | **PUT** /api/v4/connectors/myfitnesspal/settings | Update global MyFitnessPal matching settings.
...
// Get global MyFitnessPal matching settings.
MyFitnessPalSettingsAPI.myFitnessPalSettingsGetSettings() { (response, error) in
...
// Update global MyFitnessPal matching settings.
MyFitnessPalSettingsAPI.myFitnessPalSettingsSaveSettings(myFitnessPalMatchingSettings: myFitnessPalMatchingSettings) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
