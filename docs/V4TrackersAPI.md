...
// Acknowledge/snooze a tracker notification
V4TrackersAPI.trackersAckInstance(id: id, ackTrackerRequest: ackTrackerRequest) { (response, error) in
...
// Apply a preset (starts a new instance)
V4TrackersAPI.trackersApplyPreset(id: id, applyPresetRequest: applyPresetRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Complete a tracker instance
V4TrackersAPI.trackersCompleteInstance(id: id, completeTrackerInstanceRequest: completeTrackerInstanceRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create a new tracker definition
V4TrackersAPI.trackersCreateDefinition(createTrackerDefinitionRequest: createTrackerDefinitionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create a new preset
V4TrackersAPI.trackersCreatePreset(createTrackerPresetRequest: createTrackerPresetRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete a tracker definition
V4TrackersAPI.trackersDeleteDefinition(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete a tracker instance
V4TrackersAPI.trackersDeleteInstance(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete a preset
V4TrackersAPI.trackersDeletePreset(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get active tracker instances
V4TrackersAPI.trackersGetActiveInstances() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get a specific tracker definition
V4TrackersAPI.trackersGetDefinition(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get all tracker definitions. Returns public trackers for unauthenticated users, or all visible trackers for authenticated users.
V4TrackersAPI.trackersGetDefinitions(category: category) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get completed tracker instances (history)
V4TrackersAPI.trackersGetInstanceHistory(limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get all presets for the current user
V4TrackersAPI.trackersGetPresets() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get upcoming tracker expirations for calendar
V4TrackersAPI.trackersGetUpcomingInstances(from: from, to: to) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Start a new tracker instance
V4TrackersAPI.trackersStartInstance(startTrackerInstanceRequest: startTrackerInstanceRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update a tracker definition
V4TrackersAPI.trackersUpdateDefinition(id: id, updateTrackerDefinitionRequest: updateTrackerDefinitionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
