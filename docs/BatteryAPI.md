...
// Get battery readings for a device over a time period
BatteryAPI.batteryGetBatteryReadings(device: device, from: from, to: to) { (response, error) in
...
// Get battery statistics for a device or all devices
BatteryAPI.batteryGetBatteryStatistics(device: device, from: from, to: to) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get charge cycle history for a device
BatteryAPI.batteryGetChargeCycles(device: device, from: from, to: to, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get the current battery status for all tracked devices
BatteryAPI.batteryGetCurrentBatteryStatus(recentMinutes: recentMinutes) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get list of all known devices with battery data
BatteryAPI.batteryGetKnownDevices() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
