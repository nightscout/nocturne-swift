...
------------- | ------------- | -------------
[**retrospectiveGetBasalTimeline**](V4RetrospectiveAPI.md#retrospectivegetbasaltimeline) | **GET** /api/v4/Retrospective/basal-timeline | Get basal rate timeline for a day Returns basal rate data points showing scheduled and temp basal changes
[**retrospectiveGetRetrospectiveData**](V4RetrospectiveAPI.md#retrospectivegetretrospectivedata) | **GET** /api/v4/Retrospective/at | Get retrospective data at a specific point in time Returns IOB, COB, glucose, basal rate, and recent treatments
[**retrospectiveGetRetrospectiveTimeline**](V4RetrospectiveAPI.md#retrospectivegetretrospectivetimeline) | **GET** /api/v4/Retrospective/timeline | Get retrospective data for an entire day at specified interval Returns IOB, COB, glucose, and basal data for every interval throughout the day
...
// Get basal rate timeline for a day Returns basal rate data points showing scheduled and temp basal changes
V4RetrospectiveAPI.retrospectiveGetBasalTimeline(date: date, intervalMinutes: intervalMinutes) { (response, error) in
...
// Get retrospective data at a specific point in time Returns IOB, COB, glucose, basal rate, and recent treatments
V4RetrospectiveAPI.retrospectiveGetRetrospectiveData(time: time) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get retrospective data for an entire day at specified interval Returns IOB, COB, glucose, and basal data for every interval throughout the day
V4RetrospectiveAPI.retrospectiveGetRetrospectiveTimeline(date: date, intervalMinutes: intervalMinutes) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
