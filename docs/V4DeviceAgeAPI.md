...
------------- | ------------- | -------------
[**deviceAgeGetAllDeviceAges**](V4DeviceAgeAPI.md#deviceagegetalldeviceages) | **GET** /api/v4/deviceage/all | Get all device ages in a single call
[**deviceAgeGetBatteryAge**](V4DeviceAgeAPI.md#deviceagegetbatteryage) | **GET** /api/v4/deviceage/battery | Get pump battery age (BAGE)
[**deviceAgeGetCannulaAge**](V4DeviceAgeAPI.md#deviceagegetcannulaage) | **GET** /api/v4/deviceage/cannula | Get cannula/site age (CAGE)
[**deviceAgeGetInsulinAge**](V4DeviceAgeAPI.md#deviceagegetinsulinage) | **GET** /api/v4/deviceage/insulin | Get insulin reservoir age (IAGE)
[**deviceAgeGetSensorAge**](V4DeviceAgeAPI.md#deviceagegetsensorage) | **GET** /api/v4/deviceage/sensor | Get sensor age (SAGE) Returns both Sensor Start and Sensor Change events
...
// Get all device ages in a single call
V4DeviceAgeAPI.deviceAgeGetAllDeviceAges() { (response, error) in
...
// Get pump battery age (BAGE)
V4DeviceAgeAPI.deviceAgeGetBatteryAge(info: info, warn: warn, urgent: urgent, display: display, enableAlerts: enableAlerts) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get cannula/site age (CAGE)
V4DeviceAgeAPI.deviceAgeGetCannulaAge(info: info, warn: warn, urgent: urgent, display: display, enableAlerts: enableAlerts) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get insulin reservoir age (IAGE)
V4DeviceAgeAPI.deviceAgeGetInsulinAge(info: info, warn: warn, urgent: urgent, display: display, enableAlerts: enableAlerts) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get sensor age (SAGE) Returns both Sensor Start and Sensor Change events
V4DeviceAgeAPI.deviceAgeGetSensorAge(info: info, warn: warn, urgent: urgent, display: display, enableAlerts: enableAlerts) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
