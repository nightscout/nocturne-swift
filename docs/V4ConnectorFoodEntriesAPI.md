...
// Import connector food entries.
V4ConnectorFoodEntriesAPI.connectorFoodEntriesImportEntries(connectorFoodEntryImport: connectorFoodEntryImport) { (response, error) in
