...
------------- | ------------- | -------------
[**insulinCatalogGetCatalog**](V4InsulinsAPI.md#insulincataloggetcatalog) | **GET** /api/v4/insulins/catalog | Get all known insulin formulations.
[**insulinCatalogGetCatalogByCategory**](V4InsulinsAPI.md#insulincataloggetcatalogbycategory) | **GET** /api/v4/insulins/catalog/{category} | Get insulin formulations filtered by category.
...
// Get all known insulin formulations.
V4InsulinsAPI.insulinCatalogGetCatalog() { (response, error) in
...
// Get insulin formulations filtered by category.
V4InsulinsAPI.insulinCatalogGetCatalogByCategory(category: category) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
